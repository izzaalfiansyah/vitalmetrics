      ...
      body: BlocListener<PengukuranBloc, PengukuranState>(
        ...
        child: BlocBuilder<PengukuranBloc, PengukuranState>(
          ...
          builder: (context, state) {
            ...
            bool isRemaja = dataTerakhir.userUmur <= 18;
                        ...
                        children: [
                          ListItem(
                            ...
                            trailing: Row(
                              children: [
                                Text(
                                  '${dataTerakhir.userUmur} Tahun ${dataTerakhir.userBulan} Bulan',
                                  style: TextStyle(
                                    color: cPrimary,
                                  ),
                                ),
                            ...
                            trailing: Row(
                              children: [
                                ...
                                SizedBox(
                                  width: 100,
                                  child: CategoryLabel(
                                    categories: generateCategoryRange(
                                        categories.skorBadan!),
                                    value: dataTerakhir.skorBadan,
                                  ),
                                ),
                              ],
                                  ...
                                  children: [
                                    ...
                                    ListItem(
                                      ...
                                      trailing: Row(
                                        children: [
                                          Text(
                                            dataTerakhir.statusGizi!.imtPerU!,
                                            style: TextStyle(
                                              color: Colors.grey,
                                              fontSize: 13,
                                            ),
